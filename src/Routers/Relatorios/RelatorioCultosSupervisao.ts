  ...
  fastify.post(
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        ...
        const membrosCompareceramCultosFiltrados =
          membrosCompareceramCultos.map((membro) => {
            ...
            const porcentagemPresencaQuarta = (
            ...
            const porcentagemPresencaSabado = (
            ...
            const porcentagemPresencaTotalDomingoManha = (
            ...
            const porcentagemPresencaTotalDomingoTarde = (
