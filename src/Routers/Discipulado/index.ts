...
const routerRegisterDiscipulado = async (fastify: FastifyInstance) => {
  ...
  fastify.post("/discipulados/allmemberscell/existing-register", RegisterDiscipuladoController.isMembersCellRegister);
  fastify.post("/discipulados/allmemberssupervisor/existing-register", RegisterDiscipuladoController.isMembersDiscipuladoSupervisorRegister);
