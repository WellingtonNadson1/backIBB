...
const routerRegisterDiscipulado = async (fastify: FastifyInstance) => {
  ...
  fastify.post("/discipuladosibb/allmemberscell/existing-register", RegisterDiscipuladoController.isMembersCellRegister);
  fastify.post("/discipuladosibb/allmemberssupervisor/existing-register", RegisterDiscipuladoController.isMembersDiscipuladoSupervisorRegister);
