...
const routerPresencaReuniaCelula = async (fastify: FastifyInstance) => {
  ...
  fastify.post("/presencareuniaocelulas/newroute", PresencaReuniaoCelulaController.newstore);
  fastify.get("/presencareuniaocelulas/isregister/:id", PresencaReuniaoCelulaController.isregister);
